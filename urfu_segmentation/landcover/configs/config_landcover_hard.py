...
experiment_name = f'ConvNextHard_{dataset_type}_{crop_size[0]}_{loss["type"]}_{optimizer["type"]}_bsize_{actual_batch_size}'
logs_dir = 'logs'
...
if CLUSTER:
    clouds_shadows_path = r'/misc/home1/m_imm_freedata/Segmentation/Clouds/cloud_shadows'
else:
    clouds_shadows_path = r'C:\Datasets\Datasets_from_cluster\OnCloudN\train\cloud_shadows'
...
train_pipeline = [
    ...
    dict(type='HardAugmentationsTransform', 
        tile_size=512,
