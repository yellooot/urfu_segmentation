...
param_scheduler = [
    ...
    dict(
        ...
        T_max=136000,  # 160000 - 16000 (после warmup)
        eta_min=1e-7,
        begin=24000,
        end=160000,
        by_epoch=False,
...
checkpoint_config = dict(interval=2500, by_epoch=False, max_keep_ckpts=5)
...
optim_wrapper = dict(
    type='OptimWrapper',
    optimizer=dict(type='AdamW', lr=6e-5, weight_decay=0.001),
...
train_pipeline = [
    ...
    dict(type='RandomRotate', degree=10, prob=0.5),
