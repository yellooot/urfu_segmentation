...
rg2_path = Path('/misc/home6/m_imm_freedata/Segmentation/Projects/mmseg_trees/RG2')
rg3_path = Path('/misc/home6/m_imm_freedata/Segmentation/Projects/mmseg_trees/RG3_trees')

batch_size = 1 # в датасете изображения разного размера

datasets = [
    {'name': 'rg2', 'images': rg2_path / 'images', 'gt': rg2_path / 'gt'},
...
def main():
    ...
    for dataset in datasets:
        ...
        for i in range(math.ceil(len(images) / batch_size)):
            ...
            print(inference_result['predictions'].shape)
            predictions.append(inference_result['predictions'])
