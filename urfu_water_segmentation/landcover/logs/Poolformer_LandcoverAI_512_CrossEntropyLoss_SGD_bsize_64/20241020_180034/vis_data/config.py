...
experiment_name = 'Poolformer_LandcoverAI_512_CrossEntropyLoss_SGD_bsize_64'
...
vis_backends = [
    ...
    dict(
        save_dir=
        'logs/Poolformer_LandcoverAI_512_CrossEntropyLoss_SGD_bsize_64',
...
work_dir = 'logs/Poolformer_LandcoverAI_512_CrossEntropyLoss_SGD_bsize_64'
